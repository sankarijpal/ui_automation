...
public class loginPage extends actionMethods {
    ...
    public loginPage(WebDriver driver, com.base.testConfiguration configuration) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        loginPage obj=new loginPage(driver,new testConfiguration());
    }
    ...
    public void i_verify_whether_the_actual_order_tshirt_details_is_displayed_in_the_order_history_summary_page() throws Exception {
        ...
        System.out.println("Price verified successfully in order history summary page.");
    ...
    public void iVerifyTshirtDisplayedInCart(String s) throws Exception {
        ...
        waitForVisibilityOfElement(price);
        System.out.println("Price verified successfully in Cart.");
        Assert.assertTrue(isElementDisplayed(price),"Failed to verify the price.");
